...
enum {
  ...
  // INVALID_OPERATION:  Operation attempted in an illegal state (will try to
  // signal to app).
  // DEAD_OBJECT:        Signal from CodecBase to MediaCodec that MediaServer
  // has died.
  // NAME_NOT_FOUND:     Signal from CodecBase to MediaCodec that the component
  // was not found.
