...
inline static const char* asString_AVCProfile(int32_t i,
                                              const char* def = "??") {
  switch (i) {
...
inline static const char* asString_H263Profile(int32_t i,
                                               const char* def = "??") {
  switch (i) {
...
inline static const char* asString_H263Level(int32_t i,
                                             const char* def = "??") {
  switch (i) {
    case H263Level10:
      return "10";
...
inline static const char* asString_MPEG4Profile(int32_t i,
                                                const char* def = "??") {
  switch (i) {
    case MPEG4ProfileSimple:
      return "Simple";
    case MPEG4ProfileSimpleScalable:
      return "SimpleScalable";
    case MPEG4ProfileCore:
      return "Core";
    case MPEG4ProfileMain:
      return "Main";
    case MPEG4ProfileNbit:
      return "Nbit";
    case MPEG4ProfileScalableTexture:
      return "ScalableTexture";
    case MPEG4ProfileSimpleFace:
      return "SimpleFace";
    case MPEG4ProfileSimpleFBA:
      return "SimpleFBA";
    case MPEG4ProfileBasicAnimated:
      return "BasicAnimated";
    case MPEG4ProfileHybrid:
      return "Hybrid";
    case MPEG4ProfileAdvancedRealTime:
      return "AdvancedRealTime";
    case MPEG4ProfileCoreScalable:
      return "CoreScalable";
    case MPEG4ProfileAdvancedCoding:
      return "AdvancedCoding";
    case MPEG4ProfileAdvancedCore:
      return "AdvancedCore";
    case MPEG4ProfileAdvancedScalable:
...
inline static const char* asString_MPEG4Level(int32_t i,
                                              const char* def = "??") {
  switch (i) {
    case MPEG4Level0:
      return "0";
...
inline static const char* asString_MPEG2Profile(int32_t i,
                                                const char* def = "??") {
  switch (i) {
...
inline static const char* asString_MPEG2Level(int32_t i,
                                              const char* def = "??") {
  switch (i) {
    case MPEG2LevelLL:
      return "LL";
...
inline static const char* asString_AACObject(int32_t i,
                                             const char* def = "??") {
  switch (i) {
    case AACObjectMain:
      return "Main";
    ...
    case AACObjectHE:
      return "HE";
    case AACObjectScalable:
      return "Scalable";
    case AACObjectERLC:
      return "ERLC";
    case AACObjectERScalable:
      return "ERScalable";
    case AACObjectLD:
      return "LD";
    case AACObjectHE_PS:
...
inline static const char* asString_VP8Profile(int32_t i,
                                              const char* def = "??") {
  switch (i) {
    case VP8ProfileMain:
      return "Main";
...
inline static const char* asString_VP9Profile(int32_t i,
                                              const char* def = "??") {
  switch (i) {
    case VP9Profile0:
      return "0";
...
inline static const char* asString_AV1Profile(int32_t i,
                                              const char* def = "??") {
  switch (i) {
...
inline static const char* asString_HEVCProfile(int32_t i,
                                               const char* def = "??") {
  switch (i) {
...
inline static const char* asString_HEVCTierLevel(int32_t i,
                                                 const char* def = "??") {
  switch (i) {
...
inline static const char* asString_DolbyVisionProfile(int32_t i,
                                                      const char* def = "??") {
  switch (i) {
    case DolbyVisionProfileDvavPer:
      return "DvavPer";
    case DolbyVisionProfileDvavPen:
      return "DvavPen";
    case DolbyVisionProfileDvheDer:
      return "DvheDer";
    case DolbyVisionProfileDvheDen:
      return "DvheDen";
    case DolbyVisionProfileDvheDtr:
      return "DvheDtr";
    case DolbyVisionProfileDvheStn:
      return "DvheStn";
    case DolbyVisionProfileDvheDth:
      return "DvheDth";
    case DolbyVisionProfileDvheDtb:
      return "DvheDtb";
    case DolbyVisionProfileDvheSt:
      return "DvheSt";
    case DolbyVisionProfileDvavSe:
      return "DvavSe";
    case DolbyVisionProfileDvav110:
      return "Dav110";
    default:
      return def;
  }
...
inline static const char* asString_DolbyVisionLevel(int32_t i,
                                                    const char* def = "??") {
  switch (i) {
    case DolbyVisionLevelHd24:
      return "Hd24";
    case DolbyVisionLevelHd30:
      return "Hd30";
    case DolbyVisionLevelFhd24:
      return "Fhd24";
    case DolbyVisionLevelFhd30:
      return "Fhd30";
    case DolbyVisionLevelFhd60:
      return "Fhd60";
    case DolbyVisionLevelUhd24:
      return "Uhd24";
    case DolbyVisionLevelUhd30:
      return "Uhd30";
    case DolbyVisionLevelUhd48:
      return "Uhd48";
    case DolbyVisionLevelUhd60:
      return "Uhd60";
    case DolbyVisionLevelUhd120:
      return "Uhd120";
    case DolbyVisionLevel8k30:
      return "8k30";
    case DolbyVisionLevel8k60:
      return "8k60";
    default:
      return def;
  }
...
inline static const char* asString_BitrateMode(int32_t i,
                                               const char* def = "??") {
  switch (i) {
    case BITRATE_MODE_CBR:
      return "CBR";
    case BITRATE_MODE_CBR_FD:
      return "CBR_FD";
...
inline static const char* asString_ColorFormat(int32_t i,
                                               const char* def = "??") {
  switch (i) {
    ...
    case COLOR_Format64bitABGRFloat:
      return "64bitABGRFloat";
...
constexpr char KEY_AAC_MAX_OUTPUT_CHANNEL_COUNT[] =
...
constexpr char KEY_CHANNEL_COUNT[] =
    "channel-count";  // value N, eq to range 1..N
...
constexpr char KEY_CREATE_INPUT_SURFACE_SUSPENDED[] =
...
constexpr char KEY_PREPEND_HEADER_TO_SYNC_FRAMES[] =
...
constexpr char KEY_REPEAT_PREVIOUS_FRAME_AFTER[] =
...
constexpr char KEY_VIDEO_ENCODING_STATISTICS_LEVEL[] =
