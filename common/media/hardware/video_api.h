 ...
 *
 * cp from
 * https://android.googlesource.com/platform/frameworks/native/+/refs/heads/master/headers/media_plugin/media/hardware/VideoAPI.h
 */
...
struct MediaImage {
  ...
  enum PlaneIndex { Y = 0, U, V, MAX_NUM_PLANES };
...
struct __attribute__((__packed__, aligned(alignof(uint32_t)))) ColorAspects {
  ...
  // this partially in sync with the transfer values in graphics.h prior to the
  // transfers unlikely to be required by Android section
  ...
  enum Standard : uint32_t {
    ...
    StandardBT601_625_Unadjusted,  // PrimariesBT601_6_625 and KR=0.222,
                                   // KB=0.071
...
inline static const char* asString(MediaImage::Type i, const char* def = "??") {
  switch (i) {
    case MediaImage::MEDIA_IMAGE_TYPE_UNKNOWN:
      return "Unknown";
    case MediaImage::MEDIA_IMAGE_TYPE_YUV:
      return "YUV";
    default:
      return def;
  }
...
inline static const char* asString(MediaImage::PlaneIndex i,
                                   const char* def = "??") {
  switch (i) {
    case MediaImage::Y:
      return "Y";
...
inline static const char* asString(MediaImage2::Type i,
                                   const char* def = "??") {
  switch (i) {
    case MediaImage2::MEDIA_IMAGE_TYPE_UNKNOWN:
      return "Unknown";
    case MediaImage2::MEDIA_IMAGE_TYPE_YUV:
      return "YUV";
    case MediaImage2::MEDIA_IMAGE_TYPE_YUVA:
      return "YUVA";
    case MediaImage2::MEDIA_IMAGE_TYPE_RGB:
      return "RGB";
    case MediaImage2::MEDIA_IMAGE_TYPE_RGBA:
      return "RGBA";
    case MediaImage2::MEDIA_IMAGE_TYPE_Y:
      return "Y";
    default:
      return def;
  }
...
inline static char asChar2(MediaImage2::PlaneIndex i,
                           MediaImage2::Type j,
                           char def = '?') {
  const char* planes = asString(j, nullptr);
  // handle unknown values
  if (j == MediaImage2::MEDIA_IMAGE_TYPE_UNKNOWN || planes == nullptr ||
      i >= strlen(planes)) {
    return def;
  }
  return planes[i];
...
inline static const char* asString(ColorAspects::Range i,
                                   const char* def = "??") {
  switch (i) {
    case ColorAspects::RangeUnspecified:
      return "Unspecified";
    case ColorAspects::RangeFull:
      return "Full";
    case ColorAspects::RangeLimited:
      return "Limited";
    case ColorAspects::RangeOther:
      return "Other";
    default:
      return def;
  }
...
inline static const char* asString(ColorAspects::Primaries i,
                                   const char* def = "??") {
  switch (i) {
    ...
    case ColorAspects::PrimariesBT2020:
      return "BT2020";
    case ColorAspects::PrimariesOther:
      return "Other";
    default:
      return def;
  }
...
inline static const char* asString(ColorAspects::Transfer i,
                                   const char* def = "??") {
  switch (i) {
...
inline static const char* asString(ColorAspects::MatrixCoeffs i,
                                   const char* def = "??") {
  switch (i) {
...
inline static const char* asString(ColorAspects::Standard i,
                                   const char* def = "??") {
  switch (i) {
    case ColorAspects::StandardUnspecified:
      return "Unspecified";
    case ColorAspects::StandardBT709:
      return "BT709";
    case ColorAspects::StandardBT601_625:
      return "BT601_625";
    case ColorAspects::StandardBT601_625_Unadjusted:
      return "BT601_625_Unadjusted";
    case ColorAspects::StandardBT601_525:
      return "BT601_525";
    case ColorAspects::StandardBT601_525_Unadjusted:
      return "BT601_525_Unadjusted";
    case ColorAspects::StandardBT2020:
      return "BT2020";
    case ColorAspects::StandardBT2020Constant:
      return "BT2020Constant";
    case ColorAspects::StandardBT470M:
      return "BT470M";
    case ColorAspects::StandardFilm:
      return "Film";
    case ColorAspects::StandardOther:
      return "Other";
    default:
      return def;
  }
